...
tasks = [
  ["Build a Community Garden",
    ...
    2016, 12, 15, "3:00 PM", 4, "garden.jpg", city_two.id,
  ...
  ["Feed the Hungry",
    ...
    2016, 04, 05, "8:00 AM", 3, "feed.jpg", city_two.id,
  ...
  ["Clean the Beach",
    ...
    2017, 05, 30, "4:00 PM", 6,  "beach.jpg", city_one.id,
  ...
  ["Paint Saint Matthews",
    ...
    2016, 04, 30, "1:00 PM", 7, "paint.jpg", city_one.id,
    "170 S Chambers Rd, Aurora, CO 80017"],
  ["Pick up on Main Street",
    ...
    2016, 06, 24, "1:00 AM", 12, "mainst.jpg", city_two.id,
  ...
  ["Clean the Platte",
    ...
    2016, 04, 11, "3:00 PM", 3, "platte.jpg", city_two.id,
  ...
  ["Teach Shoe Tying",
    ...
    2017, 01, 01, "3:00 PM", 2, "shoes.jpg", city_one.id,
  ...
  ["Enchanted Forrest", "Dress up in a fairytale costume and give out treats to children on their hike through the enchanted prairie. Bring your own non-scary costume if you have one.",
    2016, 11, 30, "2:30 PM", 5, "halloween.jpg", city_two.id,
